...
public class Datos {
	...
	public static void cargarDatosRutasVuelo() throws Exception {
		try {
			...
			iVuelo.ingresarDatosRutaVuelo("aireuropa", "UX46", "RV01.jpeg", "Vuelo a Europa", "Tiempo de vuelo: aprox. 12 horas con comidas incluidas", 
			...
			iVuelo.ingresarDatosRutaVuelo("iberia", "IB6012", "RV02.jpeg", "Vuelo de larga duración", 
			...
			iVuelo.ingresarDatosRutaVuelo("aerolineas", "AR1380", "RV03.jpg", "Vuelo corto", 
			...
			iVuelo.ingresarDatosRutaVuelo("aerolineas", "AR1381", "RV04.jpg", "Vuelo corto", 
			...
			iVuelo.ingresarDatosRutaVuelo("zfly", "ZL1501", "RV05.jpg", "Vuelo exclusivo", 
				"Vuelo exclusivo en aviones pequeños, tiempo de vuelo 20 minutos",
			...
			iVuelo.ingresarDatosRutaVuelo("iberia", "IB6011", "RV06.jpg", "Vuelo directo a Europa", 
			...
			iVuelo.ingresarDatosRutaVuelo("aireuropa", "UX45", "RV07.jpg", "Vuelo largo",
				...
				PresentacionUtils.parseTime("23:55"), PresentacionUtils.parseDate("25/08/2024"), 
			...
			iVuelo.ingresarDatosRutaVuelo("latam", "LA406", "RV08.jpg", "Vuelo mediano", 
				"Tiempo de vuelo: alrededor de 2 horas y 30 minutos.", 
			...
			iVuelo.ingresarDatosRutaVuelo("iberia", "IB34", "RV09.jpeg", "Vuelo corto",
					"Tiempo de vuelo: aproximadamente 1 hora y 20 minutos. Ofrece vuelos directos con servicio de bebidas y snacks a bordo. Ideal para un viaje rápido y eficiente entre las dos principales ciudades españolas.",
			...
			iVuelo.ingresarDatosRutaVuelo("aireuropa", "UX1515", "RV10.jpg", "Vuelo corto",
					"Tiempo de vuelo: aproximadamente 2 horas y 30 minutos. Ofrece vuelos directos con servicio de bebidas y snacks a bordo, además de entretenimiento para hacer tu viaje más placentero. Ideal para un traslado rápido y cómodo entre las dos ciudades europeas",
			...
			iVuelo.ingresarDatosRutaVuelo("copaair", "CM284", "RV11.jpg", "Vuelo largo",
					"Tiempo de vuelo: aproximadamente 7 horas. Copa Airlines ofrece comidas, bebidas y entretenimiento a bordo para un viaje cómodo y agradable. Ideal para quienes buscan una conexión eficiente entre Sudamérica y Centroamérica",
			...
			iVuelo.ingresarDatosRutaVuelo("copaair", "CM804", "RV12.jpg", "Vuelo largo",
			...
			iVuelo.ingresarDatosRutaVuelo("latam", "LA533", "RV13.jpg", "Vuelo largo",
			...
			iVuelo.ingresarDatosRutaVuelo("copaair", "CM283", null, "Vuelo largo",
					"Elvuelo tiene una duración aproximada de 7 horas. Ofrece comidas, bebidas y entretenimiento a bordo para una experiencia de viaje cómoda y agradable",
			...
			iVuelo.ingresarDatosRutaVuelo("latam", "LA407", "RV15.jpg", "Vuelo largo",
					"El vuelo incluye bebidas y snacks a bordo, con una duración aproximada de 2 horas y 30 minutos, ofreciendo una experiencia cómoda entre las dos ciudades sudamericanas",
			...
			iVuelo.ingresarDatosRutaVuelo("zfly", "ZL1502", "RV16.jpeg", "Vuelo corto",
					"Tiempo estimado de vuelo 2 horas y 30 minutos, vuelo directo.", PresentacionUtils.parseTime("12:50"), PresentacionUtils.parseDate("28/07/2024"),
					30, 190, 75, "Montevideo", "Uruguay", "Rı́o de Janeiro", "Brasil", categorias16);
			...
			iVuelo.ingresarDatosRutaVuelo("iberia", "IB3009", "RV17.jpeg", "Vuelo corto" ,"Tiempo estimado de vuelo es de 1 hora y 40 minutos.",
			...
			// Confirmar, o Rechazar Rutas de Vuelo
			
			iVuelo.aceptarRutaVuelo("IB6012");
			iVuelo.aceptarRutaVuelo("AR1380");
			iVuelo.aceptarRutaVuelo("AR1381");
			iVuelo.aceptarRutaVuelo("ZL1501");
			iVuelo.aceptarRutaVuelo("IB6011");
			iVuelo.aceptarRutaVuelo("UX45");
			iVuelo.aceptarRutaVuelo("IB34");
			iVuelo.rechazarRutaVuelo("UX1515");
			iVuelo.aceptarRutaVuelo("CM284");
			iVuelo.aceptarRutaVuelo("CM804");
			iVuelo.rechazarRutaVuelo("LA533");
			iVuelo.aceptarRutaVuelo("CM283");
			iVuelo.aceptarRutaVuelo("IB3009");
	...
	public static void cargarDatosVuelos() throws Exception {
		try {
			...
			iVuelo.agregarVueloARuta("UX45", mVuelo.obtenerVuelo("UX45810"));
...
//			PA02	RE02	Jack	Olivera
//			PA02	RE02	Jill	Perk
			List<DTPasajero> pasajeros2 = new ArrayList<DTPasajero>();
			pasajeros2.add(new DTPasajero("Jack ", "Olivera"));
...
//			PA07	RE04	Lucas	Morales
			...
			pasajeros4.add(new DTPasajero("Ana", "Rodríguez"));
